...
class _BackgroundPropertiesState extends State<BackgroundProperties> {
  ...
  void initState() {
    super.initState();
    _controllerWidth.text = context
        .read<BackgroundCubit>()
        .state
        .width
        .toString();
    _controllerHeight.text = context
        .read<BackgroundCubit>()
        .state
        .height
        .toString();
          ...
          children: [
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    context.read<BackgroundCubit>().setWidth(
                      int.parse(_controllerWidth.text),
                    );
                  },
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    context.read<BackgroundCubit>().setHeight(
